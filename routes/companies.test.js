...
describe("GET /companies", function () {
  ...
  test("should be able to filter companies", async function () {
  ...
  test("should be able to filter companies by max or minEmployees", async function () {
    const resp = await request(app)
      .get("/companies")
  ...
  test("should get all companies if no filters provided", async function () {
